            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-md-push-4 text-center inset-sm">
                        <div class="relative"><img src="modules/themebas/images/phone-1.png" alt="" class="phone_1">
                    ...
                    <div class="col-sm-6 col-md-4 col-md-pull-4 text-md-right">
                        <div class="box-md inset-3 direction-md-rtl max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-thumb_up"></span></div>
                            <div class="box__body box__middle">
                                <h5><a href="#">Construction Consulting</a></h5>
                                <p>Our various areas of expertise are available on a consulting basis as an additional support to our ...</p>
                            </div>
                        </div>
                        <div class="box-md inset-3 direction-md-rtl max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-business"></span></div>
                            <div class="box__body box__middle">
                        ...
                        <div class="box-md inset-3 direction-md-rtl max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-build"></span></div>
                            <div class="box__body box__middle">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="box-md inset-3 max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-wb_incandescent"></span></div>
                            <div class="box__body box__middle">
                                <h5><a href="#">Design And Build</a></h5>
                                <p>Design and build are all about working efficiencies created within the design phase, thereby ...</p>
                            </div>
                        </div>
                        <div class="box-md inset-3 max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-flip_to_back"></span></div>
                            <div class="box__body box__middle">
                                <h5><a href="#">Pre-Construction Planning</a></h5>
                                <p>We seek to get involved early in the design phase so that we can manage the project more efficiently ...</p>
                            </div>
                        </div>
                        <div class="box-md inset-3 max-width">
                            <div class="box__left"><span class="icon icon-md icon-primary icon-circle-md-primary material-icons-flip_to_front"></span></div>
                            <div class="box__body box__middle">
                                <h5><a href="#">Post-Construction</a></h5>
                                <p>A project isn’t complete just after the construction phase is done. We offer additional services to help ...</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row flow-offset-2">
                    <div class="col-sm-6 col-md-4">
                        <article class="thumbnail thumbnail-4 slow-hover">
                            <div class="image-slow-wrapper"><img src="modules/themebas/images/blog-1.jpg" alt=""></div>
                            <div class="caption">
                                <h4><a href="blog_post.html">Construction Company Services</a></h4>
                                <p class="text-dark-variant-2">Our Construction Company is a superior provider of housing, educational and support services for individuals...</p>
                                <div class="blog-info">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <article class="thumbnail thumbnail-4 slow-hover">
                            <div class="image-slow-wrapper"><img src="modules/themebas/images/blog-2.jpg" alt=""></div>
                            <div class="caption">
                                <h4><a href="blog_post.html">Kitchen Remodel Inspiration</a></h4>
                                <p class="text-dark-variant-2">Every cooking geek has big dreams for their kitchen. They envision the meals they’ll prepare, the dishes they’ll serve, ...</p>
                                <div class="blog-info">
                                    <div class="pull-md-left">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <article class="thumbnail thumbnail-4 slow-hover">
                            <div class="image-slow-wrapper"><img src="modules/themebas/images/blog-3.jpg" alt=""></div>
                            <div class="caption">
                                <h4><a href="blog_post.html">Meet Our Project Manager</a></h4>
                                <p class="text-dark-variant-2">When did you start working for Construction? I’m a new hire and just started Monday of this week. Official start date was 1/18/16...</p>
                                <div class="blog-info">
                                    <div class="pull-md-left">
        ...
        <section class="well well-sm text-center section-border">
            <div class="container">
                ...
                <ul class="flex-list offset-1">
                    <li><a href="#"><img src="modules/themebas/images/partner1.png" alt=""></a></li>
                    <li><a href="#"><img src="modules/themebas/images/partner2.png" alt=""></a></li>
                    <li><a href="#"><img src="modules/themebas/images/partner3.png" alt=""></a></li>
                    <li><a href="#"><img src="modules/themebas/images/partner4.png" alt=""></a></li>
                    <li><a href="#"><img src="modules/themebas/images/partner5.png" alt=""></a></li>
                    <li><a href="#"><img src="modules/themebas/images/partner6.png" alt=""></a></li>
                </ul>
            </div>
        </section>
        <!--End section-->
            ...
            <div class="container">
                ...
                <div class="row offset-1">
                    ...
                    <div data-items="1" data-sm-items="2" data-xs-items="1" data-md-items="3" data-nav="true" data-margin="30" class="owl-carousel">
                        <div class="owl-item">
                            <blockquote class="quote-2"><img src="modules/themebas/images/index_img5.jpg" alt="" class="img-circle">
                                <h6>
                        ...
                        <div class="owl-item">
                            <blockquote class="quote-2"><img src="modules/themebas/images/index_img6.jpg" alt="" class="img-circle">
                                <h6>
                        ...
                        <div class="owl-item">
                            <blockquote class="quote-2"><img src="modules/themebas/images/index_img7.jpg" alt="" class="img-circle">
                                <h6>
