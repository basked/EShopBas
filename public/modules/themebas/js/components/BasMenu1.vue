<template>
    <div class="rd-navbar-wrap">
        <nav class="rd-navbar bg-white top-panel-none rd-navbar-fullwidth" data-layout="rd-navbar-fixed" data-hover-on="false" data-stick-up="false" data-sm-layout="rd-navbar-fullwidth">
            <div class="rd-navbar-top-panel">
                <div class="rd-navbar-inner">
                    <button data-rd-navbar-toggle=".list-inline, .fa-envelope, .fa-phone, .material-icons-shopping_cart" class="rd-navbar-collapse-toggle"><span></span></button><a href="mailto:#" class="fa-envelope">demomail@demolink.org</a><a href="callto:#" class="fa-phone">+1 (126) 598-89-75</a>
            ...
            <div class="rd-navbar-inner">
                ...
                <div class="rd-navbar-panel">
                    ...
                    <!--RD Navbar Brand-->
                    <div class="rd-navbar-brand"><a href="index.html" class="brand-name"><img src="modules/themebas/images/logo-2.png" alt=""></a>
                    </div>
                    <!--END RD Navbar Brand-->
                </div>
                <!--END RD Navbar Panel-->
                ...
                <div class="rd-navbar-nav-wrap"><a href="shop-cart.html" class="material-icons-shopping_cart"></a>
                    ...
                    <ul class="rd-navbar-nav">
                        ...
                        <li class="active rd-navbar--has-dropdown rd-navbar-submenu"><a href="#">Features</a>
                            <ul class="rd-navbar-dropdown">
                            ...
                            <span class="rd-navbar-submenu-toggle"></span></li>
                        <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a href="#">Extras</a>
                            <ul class="rd-navbar-dropdown">
                            ...
                            <span class="rd-navbar-submenu-toggle"></span></li>
                        <li class="dropdown-megamenu rd-navbar--has-megamenu rd-navbar-submenu"><a href="#">Pages</a>
                            ...
                            <span class="rd-navbar-submenu-toggle"></span></li>
                        <li class="rd-navbar--has-dropdown rd-navbar-submenu"><a href="#">Blog</a>
                            <ul class="rd-navbar-dropdown">
                                <li><a href="blog_default.html">Default Blog</a></li>
                                <li><a href="blog_columns_2.html">2 Columns Blog</a></li>
                                <li><a href="blog_columns_3.html">3 Columns Blog</a></li>
        ...
        </nav><nav class="rd-navbar bg-white top-panel-none rd-navbar--is-clone rd-navbar-fullwidth" data-layout="rd-navbar-fixed" data-hover-on="false" data-stick-up="false" data-sm-layout="rd-navbar-fullwidth">
        <div class="rd-navbar-top-panel">
            <div class="rd-navbar-inner">
                <button data-rd-navbar-toggle=".list-inline, .fa-envelope, .fa-phone, .material-icons-shopping_cart" class="rd-navbar-collapse-toggle"><span></span></button><a href="mailto:#" class="fa-envelope">demomail@demolink.org</a><a href="callto:#" class="fa-phone">+1 (126) 598-89-75</a>
                <ul class="list-inline pull-right">
