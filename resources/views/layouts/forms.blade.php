        ...
        <ul class="list-unstyled">
            ...
            <li><a href="#formsDropdown" aria-expanded="true" data-toggle="collapse"> <i class="icon-padnote"></i>Forms
                ...
                <ul id="formsDropdown" class="collapse list-unstyled show">
                    <li class="active"><a href="{{ url('/forms') }}">Basic forms</a></li>
                            ...
                            <div class="block-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control">
                                            <small class="help-block-none">A block of help text that breaks onto a new
                                                line and may extend beyond one line.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="line"></div>
